...
import { Hand, Grab, Target } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Dynamic Ring */}
        <motion.div 
          className="w-full h-full rounded-full border border-ink/40"
          animate={{ 
        ...
        {/* Coordinate Labels */}
        <div className="absolute top-14 left-14 mono-label whitespace-nowrap opacity-40">
      ...
      {cursorType === 'hand' && (
        <motion.div
          className="cursor-dot text-accent"
          style={{
            x: mouseX,
            y: mouseY,
            translateX: '-20%',
