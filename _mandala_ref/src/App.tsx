...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-accent selection:text-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative h-[60vh] md:h-[70vh] flex flex-col border-b border-ink/20">
      ...
      {/* Experience Section */}
      <section className="p-6 md:p-12 border-y border-ink/20">
      ...
      {/* Grid Sections */}
      <section className="grid grid-cols-1 md:grid-cols-2 border-b border-ink/20">
      ...
      {/* About Section */}
      <section className="p-6 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
