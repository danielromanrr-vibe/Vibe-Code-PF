...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-accent selection:text-white overflow-x-hidden bg-bg" style={{ backgroundColor: '#E4E3E0' }}>
      ...
      <section className="relative h-[60vh] md:h-[70vh] flex flex-col border-b border-ink/20 bg-transparent">
        <header className="relative z-20 p-6 md:p-12 flex justify-between items-start pointer-events-none">
          ...
          <div className="flex flex-col items-end text-right">
            ...
            <span className="font-sans text-xl md:text-2xl tracking-tight">
              {formatTime(time)}
            </span>
          </div>
        </header>
        ...
        <div className="mt-auto relative z-10 p-6 md:p-12 max-w-3xl">
          ...
          <div className="flex gap-4">
            <a href="mailto:hello@danielromandesign.com" className="label border border-ink/40 px-4 py-2 rounded-full hover:bg-ink hover:text-bg hover:opacity-100 transition-all duration-300">
              Get in touch
            </a>
          </div>
        </div>
      ...
      {/* Highlights — Adopt a School + Pop-up */}
      <section className="p-6 md:p-12 bg-bg">
        <div className="flex items-center gap-4 mb-12">
          <h3 className="text-2xl font-sans font-medium">Highlights</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
          <motion.div
            whileHover={{ y: -4 }}
            className="group relative bg-white border border-ink p-8 flex flex-col justify-between h-[300px] shadow-[8px_8px_0px_0px_rgba(20,20,20,1)] hover:shadow-[12px_12px_0px_0px_rgba(20,20,20,1)] transition-all duration-300 cursor-pointer"
            onClick={() => setOpenAdoptPopup(true)}
          >
            <div>
              <div className="flex justify-between items-start mb-4">
                <span className="label">{ADOPT_A_SCHOOL.caseId}</span>
                <ArrowUpRight className="opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
              <h4 className="text-2xl font-sans font-medium mb-4">{ADOPT_A_SCHOOL.title}</h4>
            ...
            <button
              type="button"
              className="text-sm font-sans underline underline-offset-4 hover:text-accent transition-colors text-left"
        ...
        {openAdoptPopup && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-bg border border-ink shadow-xl overflow-hidden max-h-[90vh] flex flex-col"
      ...
      <section className="p-6 md:p-12 border-y border-ink/20 bg-bg">
        <div className="max-w-4xl">
          <span className="label mb-6 block">Professional Trajectory</span>
          <h3 className="text-3xl md:text-4xl mb-8 font-sans font-medium">Working with cross-functional teams</h3>
